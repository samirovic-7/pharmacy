...
<body>
    ...
    <div class="shopping_cart">
        <div class="container">
            ...
            <div class="row" >
                <div class="col-lg-9">
                    <div class="shopping_card_header">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="checkout">
                        <div class="checkout_header">
                            ...
                            <ul class="list_unstyled">
                                <li> <p class="lead"> Subtotal </p>   <span class="price"> $12000  </span>    </li>

                                <li> <p class="lead"> Shipping (Flat Rate - Fixed) </p>   <span class="price"> $15.00 </span>    </li>

                                <li> <p class="lead"> Order Total </p>   <span class="price bold"> $1,435.00  </span>    </li>

                                <li> <p class="lead"> Subtotal </p>   <span class="price"> $12000  </span>    </li>
                            </ul>
                            <button type="button" class="btn btn-dark btn-lg"> <span> Proceed to Checkout </span> </button>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <script src="front_code/show_cart.js"></script>
