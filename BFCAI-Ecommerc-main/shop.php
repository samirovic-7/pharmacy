                                            ...
                                            <div class="cart_icon_content">
                                                ...
                                                <div class="cart_products">
                                                    <div class="items_total">
                                                            ...
                                                            <div class="items_subtotal">Cart Subtotal :<h3>$270.00</h3></div>
                                                    </div><!-- ./items_total -->
                                                    <a href="chekout.html" class="to_checkout opacity_hover">Proceed to Checkout</a>
                                                    <div class="cart_items">
                                                        <div class="item">
                                                            <div class="item_img"><a href="product.html"><img src="assets/image/shop/products/product_1.jpg" alt=""></a></div>
                                                            <div class="item_details">
                                                                <a href="product.html" class="item_name">Rhinocort Allergy Nasal Spray Budesonide</a>
                                                                <p class="item_price">$270.00</p>
                                                                <label for="qty">Qty:</label><input type="text" id="qty" placeholder="1" class="qty_num">
                                                                <button class="remove"><i class="far fa-trash-alt"></i></button>
                                                            </div><!-- ./item_details -->
                                                        </div><!-- ./item -->
                                                    </div><!-- ./cart_items -->
                                                    <a href="card.html" class="view_cart opacity_hover">View and Edit Cart</a>
                                                </div><!-- ./cart_products -->
                    ...
                    <div class="bottom_header_content">
                        ...
                        <nav>
                            <ul class="nav_items">
                                ...
                                <li><a href="shop.html" class="text_blue_hover active position-relative">shop <img src="assets/image/index/nav/sale.png" alt=""></a></li>
...
<div id="login1">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-3 col-md-4">
                            <div class="filters">
                                <div class="filters_title"><h2>Filter Products By</h2></div>
                                ...
                                <div class="active_filters">
                                    <div class="active_item">
                                        ...
                                        <div class="active_item_content">
                                            <ul class="active_item_list">
                                                <li><span class="item">personal care</span> <span class="item_del">x</span></li>
                                            </ul><!-- ./active_item_list -->
                                    ...
                                    <div class="active_item">
                                        ...
                                        <div class="active_item_content">
                                            <ul class="active_item_list">
                                                <li><span class="item">$150.00 - $464.00</span> <span class="item_del">x</span></li>
                                            </ul><!-- ./active_item_list -->
                                        </div><!-- ./active_item_content -->
                                    </div><!-- ./active_item -->
                                    <div class="active_item">
                                        ...
                                        <div class="active_item_content">
                                            <ul class="active_item_list">
                                                <li><span class="item">The Back Yard</span> <span class="item_del">x</span></li>
                                            </ul><!-- ./active_item_list -->
                                        </div><!-- ./active_item_content -->
                                    </div><!-- ./active_item -->
                                    <div class="active_item">
                                ...
                                <div class="filters_item">
                                    ...
                                    <div class="filters_item_content">
                                        <ul class="filters_item_list" id="category">
                                ...
                                <div class="filters_item">
                                    ...
                                    <div class="filters_item_content">
                                        <div class="price_filter">
                                            ...
                                            <p class="price_filter_content">$ <input type="text" id="amount" readonly> - $ <input type="text" id="amount2" readonly></p>
                                        </div><!-- ./price_filter -->
                                    </div><!-- ./filters_item_content -->
                                </div><!-- ./filters_item -->
                                <div class="filters_item">
                                    <h3 class="filters_item_title">Manufacturer products</h3>
                                    <div class="filters_item_content">
                                        <ul class="filters_item_list" id="sidebar_product">
                                ...
                                <div class="filters_item">
                                    ...
                                    <div class="filters_item_content">
                                        <ul class="filters_item_list colors">
                                            <li><a href="#"><div class="color_item" style="background-color: yellow;"></div></a></li>
                                            <li><a href="#"><div class="color_item" style="background-color: blue;"></div></a></li>
                                            <li><a href="#"><div class="color_item" style="background-color: brown;"></div></a></li>
                                            <li><a href="#"><div class="color_item" style="background-color: gray;"></div></a></li>
                                            <li><a href="#"><div class="color_item" style="background-color: violet;"></div></a></li>
                                            <li><a href="#"><div class="color_item" style="background-color: red;"></div></a></li>
                                            <li><a href="#"><div class="color_item" style="background-color: black;"></div></a></li>
                                        </ul><!-- ./filters_item_list -->
                                    </div><!-- ./filters_item_content -->
                                </div><!-- ./filters_item -->
                                <div class="filters_item">
                                    ...
                                    <div class="filters_item_content">
                                        <ul class="filters_item_list size">
                                            <li><a href="#"><div class="size_item" >L</div></a></li>
                                            <li><a href="#"><div class="size_item" >M</div></a></li>
                                            <li><a href="#"><div class="size_item" >10 cm</div></a></li>
                                            <li><a href="#"><div class="size_item" >15 cm</div></a></li>
                                            <li><a href="#"><div class="size_item" >20 cm</div></a></li>
                                            <li><a href="#"><div class="size_item" >25 cm</div></a></li>
                                            <li><a href="#"><div class="size_item" >30 cm</div></a></li>
                                            <li><a href="#"><div class="size_item" >35 cm</div></a></li>
                                            <li><a href="#"><div class="size_item" >40 cm</div></a></li>
                                            <li><a href="#"><div class="size_item" >45 cm</div></a></li>
                                            <li><a href="#"><div class="size_item" >50 cm</div></a></li>
                                        </ul><!-- ./filters_item_list -->
                                    </div><!-- ./filters_item_content -->
                                </div><!-- ./filters_item -->
                                <a href="#" class="filter_banner"><img src="assets/image/shop/banner-sidebar.png" alt="" ></a>
                            </div><!-- ./filters -->
                        </div>
                        <div class="col-lg-9 col-md-8">
                            <div class="products">
                                ...
                                <div class="toolbar "  >
                                    ...
                                    <ul class="view_type nav nav-tabs" id="myTab" role="tablist">
                                        <li class="" role="presentation"><i class="fas fa-th-large  active"   id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true"></i></li>
                                        <li class="" role="presentation"> <i class="fas fa-list "  id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false"></i></li>
                                    </ul><!-- ./view_type -->
        ...
        <script src="front_code/shop.js"></script>
        <script src="front_code/addfavourite.js"></script>
        
    <script src="front_code/addcart.js"></script>
    </body>
</html>