...
$products = $con->prepare("SELECT * FROM products WHERE id=:id");
    ...
    <div class="product_detail">
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    <div class="img">
                        <img src="../admin/php_code/upload/avatar/<?php echo $fetch_product["image"] ?>" alt="" srcset="">
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="product_detail_content">
                        ...
                        <h2 class="product_name h1">
                            <?php  echo $fetch_product["product_name"]?>
                        </h2>
                        <p class="product_content">
                        <?php echo $fetch_product["product_content"] ?>
                        </p>
                        <?php
                                if($fetch_product["status"] == 1)
                                {
                                    ?> <p class="price"> $<?php echo $fetch_product["price2"] -  ( $fetch_product["price2"] *  $fetch_product["discount"]  / 100 )  ?> <span>$<?php echo $fetch_product["price2"] ?> </span> </p> <?php 
                                }
                                else
                                {
                                    ?> <p class="price"> $<?php echo $fetch_product["price2"]  ?>  </p> <?php   
                                }
                            ?>
           
                        <div class="item_options">
                                            <button class="add_to_cart option bg_blue_text_whi_hover first" onclick="add_cart(<?php echo $fetch_product['id'] ?>)" >ADD TO CART</button>
                                            <button class="add_to_fav option bg_blue_text_whi_hover"  onclick="add_fav(<?php echo $fetch_product['id'] ?>)"><i class="far fa-heart"></i></button>
                ...
                <div class="col-lg-3">
                    <div class="side">
                        <h2 class="h1 other_products"> other products </h2>
                        <?php
                        $others = $con->prepare("SELECT * FROM products LIMIT 4");
                        $others->execute();
                        $others_fetch = $others->fetchAll();
                        foreach($others_fetch as $other)
                        {
                            ?>
                                <div class="side_content">
                                    <div class="row">
                                        <div class="col-lg-5">
                                            <div class="img">
                                                <img src="../admin/php_code/upload/avatar/<?php echo $other["image"] ?>" alt="">
                                            </div>
                                        </div>
                                        <div class="col-lg-7">
                                            <div class="link">
                                                <a href="product_detail.php?id=<?php echo $other["id"] ?>"> <?php echo $other["product_name"] ?>  </a>
                                                <?php
                                                    if($other["status"] == 1)
                                                    {
                                                        ?> <p class="price"> $<?php echo $other["price2"] -  ( $other["price2"] *  $other["discount"]  / 100 )  ?> <span>$<?php echo $other["price2"] ?> </span> </p> <?php 
                                                    }
                                                    else
                                                    {
                                                        ?> <p class="price"> $<?php echo $other["price2"] -  ( $other["price2"] *  $other["discount"]  / 100 )  ?>  </p> <?php   
                                                    }
                                                ?>
