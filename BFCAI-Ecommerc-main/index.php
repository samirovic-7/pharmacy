...
$sel = $con->prepare("SELECT * FROM category WHERE activate=0");
    ...
    <main>
        ...
        <section class="categories padd">
            <div class="container">
                ...
                <div class="owl-carousel owl-theme"id="categories_product" > 
                ...
                <div class="item">
                    <a href="category_product.php?id=<?php echo $fet["id"] ?>" class="categories_item">
                        <div class="categories_item_img"><img src="../admin/php_code/upload/avatar/<?php echo $fet["image"] ?>"alt=""></div>
                        <div class="categories_item_text">
                            <h3 class="categories_item_title"><?php echo $fet["title"] ?></h3>
                        ...
                        <div class="deals_items col-lg-9 col-12">
                            <div class="owl-carousel owl-theme">
                                <?php
                                    ...
                                    $deals = $con->prepare("SELECT * FROM products WHERE activate=0 && `status`=1 ");

                                    $deals->execute();

                                    $fets_deals = $deals->fetchAll();

                                    foreach($fets_deals as $fet_deals)
                                    {
                                        ?>
                                    ...
                                    <div class="item_content product_content">
                                        ...
                                        <a href="product.html" class="item_img"><img src="../admin/php_code/upload/avatar/<?php echo $fet_deals["image"] ?>"alt=""></a>
                                        <p><a href="shop.html" class="item_cat"> <?php echo $fet_deals["category_id"] ?> </a></p>
                                        <a href="product.html" class="item_name text_blue_hover"> <?php echo $fet_deals["product_name"] ?></a>
                                        <div class="item_rate">
                                        ...
                                        <div class="item_price"><span class="new_price">  <?php echo $fet_deals["price2"] -  ( $fet_deals["price2"] *  $fet_deals["discount"] ) / 100  ?> </span><span class="old_price"><?php echo $fet_deals["price2"]?>$  </span></div>
                                    </div><!-- ./item_content -->
                                </div><!-- ./item -->
            ...
            <div class="container">
                ...
                <div class="row">
                    <?php
                        ...
                        $tops = $con->prepare("SELECT * FROM products WHERE activate=0 LIMIT 8");

                        $tops->execute();

                        $fet_tops  = $tops->fetchAll();
                        
                        foreach($fet_tops as $fet_top)
                        {
                            ?>
                    <div class="top_week_item col-xl-3 col-md-4 col-sm-6 col-12">
                        <div class="item_content product_content">
                            ...
                            <a href="product_detail.php?id=<?php echo $fet_top["id"] ?>" class="item_img"><img src="assets/image/index/products/product_18.jpg" alt=""></a>
                            <p><a href="shop.html" class="item_cat">shop</a></p>
                            <a href="product_detail.php?id=<?php echo $fet_top["id"] ?>" class="item_name text_blue_hover">Chicco Key Fit Infant Orion</a>
                            <div class="item_rate">
                                <i class="far fa-star active"></i>
                                <i class="far fa-star active"></i>
                                <i class="far fa-star active"></i>
                            ...
                            <div class="position-relative">
                                <div class="item_price"><span class="new_price">$250.00</span><span class="old_price">$255.00</span></div>
                                <button class="add_to_cart option bg_blue_text_whi_hover first" title="Add to cart" onclick="add_cart(<?php echo $fet_top['id'] ?>)" id="<?php echo $fet_top["id"] ?>"><i class="fas fa-shopping-cart"></i></button>
                                <div class="item_options">
                                    <button class="add_to_fav option bg_blue_text_whi_hover"  onclick="add_fav(<?php echo $fet_top['id'] ?>)" title="Add to wishlist"><i class="far fa-heart"></i></button>
...
<?php
            ...
            <div class="container">
                <div class="row">
                    <div class="blog_item col-lg-6 col-12">
                        ...
                        <?php
                            $blog = $con->prepare("SELECT * FROM blogs limit 2");

                            $blog->execute();

                            $fets_blog = $blog->fetchAll();

                            foreach($fets_blog as $fet_blog)
                            {
                                ?>
                                    <div class="row align-items-center mb-4">
                                        <div class="col-sm-4">
                                            <a href="blogdatails.php?id=<?php echo $fet_blog["id"] ?>" class="blog_item_img opacity_hover"><img src="../admin/php_code/upload/avatar/<?php echo $fet_blog["image"] ?>" /></a>
                                        </div>
                                        <div class="col-sm-8 ">
                                            <div class="blog_item_text">
                                                <span class="blog_date"> <?php echo $fet_blog["data"] ?> </span>
                                                <a href="blogdatails.php?id=<?php echo $fet_blog["id"] ?>" class="blog_title text_blue_hover"> <?php echo $fet_blog["title"] ?> </a>
                                            </div><!-- ./blog_item_text -->
                                        </div>
                                    </div><!-- ./row -->
                    ...
                    <div class="blog_item col-lg-6 col-12">
                        <div class="owl-carousel owl-theme">
                            <div class="item">
                               <div class="blog_post">
                                   <div class="post_desc">
                                       <p>This is a great design and i hope that we will create a website with a good signature. Magentech team is reactive and kind. Thanks for the help so far.</p>
                                    </div><!-- ./post_desc -->
    ...
    <script src="front_code/index.js"></script>
